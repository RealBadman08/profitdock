...
const AccountSwitcherFooter = ({
    ...
    const active_account = loginid ? accountList[loginid] : undefined;
    const account_currency = active_account?.currency || '';
    ...
    const is_virtual =
        active_account?.is_virtual === true ||
        active_account?.account_type === 'demo' ||
        loginid?.startsWith('VRTC') ||
        account_param === 'demo' ||
        false;
    const show_manage_button = !is_virtual && type !== 'demo';
    ...
    return (
        <div className=''>
            ...
            {is_virtual_tab && (
                <div className='account-switcher-footer__actions account-switcher-footer__actions--hide-manage-button'>
                    <Button
                        id='logout-button'
                        className='logout-button'
                        is_loading={is_logging_out}
