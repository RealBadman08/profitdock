                    ...
                    if (type === transaction_elements.CONTRACT) {
                        return (
                            <div className={`${PARENT_CLASS}__table-row`} key={data?.transaction_ids?.buy}>
                                ...
                                <TableCell
                                    label={
                                        <IconWrapper
                                            ...
                                            icon={<MarketIcon type={data?.underlying || data?.underlying_symbol} size='sm' />}
                                        />
                                    }
                                />
                                <TableCell
                                ...
                                />
                                <TableCell label={data?.entry_tick || (data?.is_completed ? '—' : '')} loader={!data?.entry_tick && !data?.is_completed} />
                                <TableCell label={data?.exit_tick || (data?.is_completed ? '—' : '')} loader={!data?.exit_tick && !data?.is_completed} />
