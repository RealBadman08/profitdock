...
export default class SelfExclusionStore {
    ...
    async checkRestriction() {
        if (isCustomLegacyOAuthDomain()) {
            // ProfitDock currently authenticates through Deriv OAuth and reuses a public
            // websocket bootstrap. Self-exclusion on the legacy websocket returns
            // AuthorizationRequired and was logging the user out a few seconds after login.
            return;
        }
