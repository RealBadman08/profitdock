...
const AppWrapper = observer(() => {
    ...
    const GetHashedValue = (tab: number) => {
        ...
        const nextIndex = Number(hash.indexOf(String(tab_value)));
        return nextIndex >= 0 ? nextIndex : tab;
    };
    ...
    React.useEffect(() => {
        const next_hash_tab = location.hash?.split('#')[1];
        if (!next_hash_tab) {
            return;
        }

        const next_tab_index = hash.indexOf(next_hash_tab);
        if (next_tab_index >= 0 && next_tab_index !== active_tab) {
            setActiveTab(next_tab_index);
        }
    ...
    useEffect(() => {
        ...
        if (dashboard_strategies.length > 0) {
            ...
            timer = setTimeout(() => {
                void getScratchUtils().then(({ updateWorkspaceName }) => updateWorkspaceName());
            });
        }
        return () => {
                    ...
                    <div>
                        ...
                        >
                            <div
                                label={
                                    <>
                                        <DashboardNavIcon height='24px' width='24px' />
                            ...
                            <div
                                label={
                                    <>
                                        <AnalysisToolNavIcon height='24px' width='24px' />
                            ...
                            <div
                                label={
                                    <>
                                        <CopyTradingNavIcon height='24px' width='24px' />
                            ...
                            <div
                                label={
                                    <>
                                        <AccumulatorsNavIcon height='24px' width='24px' />
                            ...
                            >
                                <div className='new-feature-wrapper'>
                                    <Suspense
                                        fallback={
                                            <ChunkLoader message={localize('Please wait, loading Accumulators...')} />
                                        }
                                    >
                                        <AccumulatorsPage />
                                    </Suspense>
                            ...
                            <div
                                label={
                                    <>
                                        <FlipperSwitcherNavIcon height='24px' width='24px' />
                                        <Localize i18n_default_text='Flipper Switcher' />
                                    </>
                                }
                            ...
                            >
                                <div className='new-feature-wrapper'>
                                    <Suspense
                                        fallback={
                                            <ChunkLoader
                                                message={localize('Please wait, loading Flipper Switcher...')}
                                            />
                                        }
                                    >
                                        <FlipperSwitcherPage />
                            ...
                            <div
                                label={
                                    <>
                                        <CorsaNavIcon height='24px' width='24px' />
                                        <Localize i18n_default_text='Corsa' />
                                    </>
                                }
                                id='id-corsa'
                            >
